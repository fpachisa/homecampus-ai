...
export const UnifiedAuthForm: React.FC<UnifiedAuthFormProps> = ({
  ...
  const canSubmit = email.trim() && isValidEmail(email) && !loading;
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <input
            ...
            className="w-full px-4 py-3.5 rounded-lg text-base transition-all focus:outline-none"
            style={{
        ...
        <button
          ...
          style={{
            ...
            border: canSubmit ? 'none' : `1.5px solid ${theme.colors.border}`,
            opacity: 1,
