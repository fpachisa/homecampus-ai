 ...
 * 
 * General-purpose table renderer for matrices and other table types
 */

import type { QuestionTable } from '../../types/examQuestions';
import MathText from '../MathText';

export default function GenericTable({ headers, rows, key, caption, notes }: QuestionTable) {
    return (
        <div className="table-container generic-table">
