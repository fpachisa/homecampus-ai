...
export interface PreWrittenQuestion {
  ...
  // Used for diagrams needed to UNDERSTAND the problem (e.g., triangle with labeled sides)
  // These are shown WITH the problem, before the student answers
  mathTool?: {
    toolName: string;              // e.g., "setVisualizer", "rightTriangle"
    parameters: Record<string, any>; // Tool-specific parameters
  };

  // NEW: Solution math tool - interactive visualizations shown ONLY with the solution
  // Used for visualizations that show the ANSWER/WORKING (e.g., fractionDivision with steps)
  // These are shown AFTER the student submits or clicks "Show Solution"
  solutionMathTool?: {
    toolName: string;              // e.g., "fractionDivision", "barModel"
    parameters: Record<string, any>; // Tool-specific parameters
  };
...
export interface PathProblem {
  ...
  // Used for diagrams needed to UNDERSTAND the problem (shown WITH the problem)
  mathTool?: {
  ...
  // Solution math tool - interactive visualizations shown ONLY with the solution
  // Used for visualizations that show the ANSWER/WORKING (e.g., fractionDivision with steps)
  solutionMathTool?: {
    toolName: string;               // e.g., "fractionDivision", "barModel"
    parameters: Record<string, any>; // Tool-specific parameters
