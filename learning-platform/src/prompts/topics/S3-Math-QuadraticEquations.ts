...
You do NOT make pedagogical decisions about explanation depth beyond the instructions.`,
  ...
  // ============================================
  // GLOBAL: Math Tools (Quadratic-Specific Visualizers)
  // ============================================
  MATH_TOOLS: {
    description: "Pre-built visualization tools for quadratic equations and functions. Use these to help students visualize concepts.",
    ...
    availableTools: {
      parabolaGraph: {
        ...
        description: "Interactive parabola with labeled features (vertex, axis of symmetry, intercepts). Use for teaching graph properties.",

        parameters: {
          a: "number - coefficient of x² (determines opening and width)",
          h: "number - x-coordinate of vertex",
          k: "number - y-coordinate of vertex",
          form: "'vertex' | 'factored' | 'standard' - which form to display",
          showVertex: "boolean (default: true) - label vertex point",
          showAxisOfSymmetry: "boolean (default: true) - show vertical line x = h",
          showIntercepts: "boolean (default: false) - show x and y intercepts",
          showGrid: "boolean (default: true) - show coordinate grid",
          xRange: "[min, max] - x-axis range (default: [-10, 10])",
          yRange: "[min, max] - y-axis range (default: [-10, 10])"
        },

        exampleUsage: {
          scenario: "Graphing f(x) = (x - 2)² + 3",
          caption: "Parabola with vertex at (2, 3), opening upward",
          parameters: {
            a: 1,
            h: 2,
            k: 3,
      ...
      factoringVisualizer: {
        name: "Factoring Process Visualizer",
        technicalName: "factoringVisualizer",
        component: "FactoringVisualizer",
        description: "Step-by-step visualization of factoring quadratics. Shows factor pairs, split middle term method, or difference of squares.",

        parameters: {
          equation: "string - quadratic equation (e.g., 'x² - 5x + 6 = 0')",
          a: "number - coefficient of x²",
          b: "number - coefficient of x",
          c: "number - constant term",
          method: "'factor-pairs' | 'split-middle' | 'difference-squares' - factoring method",
          showSteps: "boolean (default: true) - show intermediate steps",
          highlightFactors: "boolean (default: false) - highlight factor pairs"
        },

        exampleUsage: {
          scenario: "Factoring x² - 5x + 6 = 0",
          caption: "Finding factors of 6 that add to -5: (-2) and (-3)",
          parameters: {
            equation: "x² - 5x + 6 = 0",
            a: 1,
            b: -5,
      ...
      completingSquareVisualizer: {
        ...
        description: "Visual representation of completing the square method. Shows geometric interpretation and algebraic steps.",
        ...
        parameters: {
          ...
          showAlgebraic: "boolean (default: true) - show algebraic steps",
          highlightPerfectSquare: "boolean (default: true) - highlight (x + p)² form"
        },

        exampleUsage: {
          scenario: "Completing the square for x² + 6x + 5 = 0",
          caption: "Rewriting as (x + 3)² - 4 = 0",
          parameters: {
            a: 1,
            b: 6,
            c: 5,
      ...
      quadraticFormulaVisualizer: {
        ...
        description: "Step-by-step application of quadratic formula. Shows substitution, simplification, and final answer.",

        parameters: {
          a: "number - coefficient of x²",
          b: "number - coefficient of x",
          c: "number - constant term",
          showSubstitution: "boolean (default: true) - show formula substitution",
          showDiscriminant: "boolean (default: true) - highlight b² - 4ac",
          showSimplification: "boolean (default: true) - show simplification steps"
        },

        exampleUsage: {
          scenario: "Using quadratic formula for 2x² + 3x - 5 = 0",
          caption: "Substituting a=2, b=3, c=-5 into the formula",
          parameters: {
            a: 2,
            b: 3,
            c: -5,
      ...
      vertexFormTransform: {
        name: "Vertex Form Transformation Visualizer",
        technicalName: "vertexFormTransform",
        component: "VertexFormTransformVisualizer",
        description: "Shows how changing h and k transforms the parabola. Interactive sliders for vertex form parameters.",

        parameters: {
          baseParabola: "boolean (default: true) - show y = x² as reference",
          a: "number - vertical stretch/compression",
          h: "number - horizontal shift",
          k: "number - vertical shift",
          showTransformations: "boolean (default: true) - label transformations",
          animateTransform: "boolean (default: false) - animate from base to transformed"
        },

        exampleUsage: {
          scenario: "Transforming y = x² to y = 2(x - 3)² + 1",
          caption: "Vertical stretch by 2, shift right 3, shift up 1",
          parameters: {
            baseParabola: true,
            a: 2,
            h: 3,
      ...
      rootsVisualizer: {
        name: "Roots and x-intercepts Visualizer",
        technicalName: "rootsVisualizer",
        component: "RootsVisualizer",
        description: "Shows relationship between roots (solutions) and x-intercepts on the graph. Highlights factored form.",

        parameters: {
          root1: "number - first root (p in factored form)",
          root2: "number - second root (q in factored form)",
          a: "number (default: 1) - vertical stretch",
          showFactoredForm: "boolean (default: true) - display a(x - p)(x - q)",
          showOnGraph: "boolean (default: true) - mark roots on parabola",
          highlightVertex: "boolean (default: true) - show vertex (midpoint of roots)"
        },

        exampleUsage: {
          scenario: "Graphing f(x) = (x - 1)(x - 5)",
          caption: "Roots at x = 1 and x = 5, vertex at (3, -4)",
          parameters: {
            root1: 1,
            root2: 5,
            a: 1,
      ...
      wordProblemDiagram: {
        ...
        description: "Context-specific diagram for word problems (fencing, projectile motion, area optimization).",

        parameters: {
          context: "'fencing' | 'projectile' | 'area' | 'profit' - problem type",
          labels: "object - custom labels for diagram elements",
          showDimensions: "boolean (default: true) - show variable dimensions",
          showEquation: "boolean (default: false) - display derived equation"
        },

        exampleUsage: {
          scenario: "Rectangular garden with fixed perimeter",
          caption: "Width = x, Length = (40 - x), Area = x(40 - x)",
          parameters: {
            context: "fencing",
            labels: {
              width: "x",
    ...
    usageGuidelines: [
      "Use parabolaGraph for teaching graph features and transformations",
      "Use factoringVisualizer when solving by factorization",
      "Use completingSquareVisualizer for completing the square method",
      "Use quadraticFormulaVisualizer for quadratic formula applications",
      "Use vertexFormTransform for vertex form and transformations",
      "Use rootsVisualizer to connect solutions to graph features",
      "Use wordProblemDiagram for real-world application problems",
      "CRITICAL: Always use the technical name in toolName field (e.g., 'parabolaGraph', NOT 'Parabola Graph Visualizer')"
    ]
  },
