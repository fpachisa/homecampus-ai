...
export const topicsByGrade: Record<GradeLevel, Topic[]> = {
  'Primary 5': [
    ...
    },
    {
      ...
      name: 'Rate',
      icon: '⏱️',
      description: 'Learn what rate means, find unit rates, use rates to calculate, and solve word problems with tables and tiered rates',
      subtopicCount: 2,
      isActive: true,
      category: 'p5-math-rate',
      grade: 'Primary 5',
      subject: 'Mathematics',
    },
    {
      ...
      name: 'Percentage',
      icon: '💯',
      description: 'Learn percent meaning, convert between fractions/decimals/percentages, solve pie charts, and apply GST, discount and interest',
      subtopicCount: 5,
      isActive: true,
      category: 'p5-math-percentage',
      grade: 'Primary 5',
      subject: 'Mathematics',
    },
    {
      ...
      name: 'Angles',
      icon: '📐',
      description: 'Master angles on a straight line, vertically opposite angles, angles at a point, and finding unknown angles',
      subtopicCount: 4,
      isActive: true,
      category: 'p5-math-angles',
      grade: 'Primary 5',
      subject: 'Mathematics',
    },
    {
  ...
  'Primary 6': [
    {
      id: 'p6-math-fractions',
      name: 'Fractions',
      icon: '🍕',
      description: 'Master division of fractions: dividing fractions by whole numbers, whole numbers by fractions, and fractions by fractions',
      subtopicCount: 4,
      isActive: true,
      category: 'p6-math-fractions',
      grade: 'Primary 6',
      subject: 'Mathematics',
    },
    {
